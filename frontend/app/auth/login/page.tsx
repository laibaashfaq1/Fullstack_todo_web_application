...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await login(email, password); // Use the imported login function
      ...
      >
        ...
        <div className="text-sm text-center">
          <p className="text-gray-600 dark:text-gray-400">
            ...
            <Link href="/auth/signup" className="font-medium text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 hover:underline transition-colors">
              Sign up
            </Link>
          </p>
        </div>
